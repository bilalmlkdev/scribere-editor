...
export default function DropCap({ onDropCapChange, currentDropCap = false }) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {openMenu && (
        <div
          className={`absolute top-full mt-1 right-0 w-[180px] bg-black backdrop-blur-md border-2 border-gray-200/10 rounded-[8px] shadow-2xl shadow-black/50 overflow-hidden z-50  transition-all duration-200 ease-out origin-top-right
