...
export default function KaomojiSelector({ onInsert, currentText = '' }) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {openMenu && (
        <div
          className={`absolute top-full mt-1 left-0 w-[320px] bg-black backdrop-blur-md border-2 border-gray-200/10 rounded-[8px] shadow-2xl shadow-black/50 overflow-hidden z-50 transition-all duration-200 ease-out origin-top-right
